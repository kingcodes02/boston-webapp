...
st.write("""
# Boton House Price Prediction App
...
st.write('**RM** - average bumber of rooms per dwelling.')
...
st.write('**B** - Percentage of lower status of the population.')
st.write('**LSTAT** - Per capita crime rate per town.')
...
if chart_select == 'Scatterplots':
    st.sidebar.subheader('Scatterplot Setttings')
    try:
...
if chart_select == 'Lineplots':
    st.sidebar.subheader('Lineplot Setttings')
    try:
        x_values = st.sidebar.selectbox('X axis', options=numeric_columns)
        y_values = st.sidebar.selectbox('Y axis', options=numeric_columns)
...
if chart_select == 'Boxplot':
    st.sidebar.subheader('Boxplot Setttings')
    try:
        x_values = st.sidebar.selectbox('X axis', options=numeric_columns)
        y_values = st.sidebar.selectbox('Y axis', options=numeric_columns)
